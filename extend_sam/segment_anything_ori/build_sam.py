...
def build_sam_vit_b(num_classes, pixel_mean=[248.24839315, 248.24885744, 248.24505519], 
                    pixel_std=[37.15942648, 37.15942648, 37.15942648],
                    checkpoint=None):
    return _build_sam(
...
def _build_sam(
    ...
    sam = Sam(
        ...
        mask_decoder=MaskDecoder(
            num_multimask_outputs=num_classes, # num_classes
