...
class BaseExtendSam(nn.Module):
    ...
    def __init__(self, class_num, ckpt_path=None, fix_img_en=False, fix_prompt_en=False, fix_mask_de=False, model_type='vit_b'):
        ...
        self.ori_sam = sam_model_registry[model_type](num_classes=class_num, checkpoint=ckpt_path)
        self.img_adapter = BaseImgEncodeAdapter(self.ori_sam, fix=True)
...
class SemanticSam(BaseExtendSam):
    ...
    def __init__(self, ckpt_path=None, fix_img_en=False, fix_prompt_en=False, fix_mask_de=False, class_num=4, model_type='vit_b'):
        super().__init__(class_num=class_num, ckpt_path=ckpt_path, fix_img_en=fix_img_en, fix_prompt_en=fix_prompt_en,
